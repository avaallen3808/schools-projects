  ...
  return (
    <section className="px-8 py-10">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl" style={{ fontFamily: 'Prata, serif' }}>Halaman</h1>
        <button onClick={() => setIsOpen(true)} className="px-5 py-2 text-sm font-medium"
          style={{ background: '#fdc72f', color: '#000', borderRadius: 100, border: 'none', cursor: 'pointer' }}>+ Halaman Baru</button>
      </div>
